...
class TodoItemsControllerTest < ActionController::TestCase
  ...
  test "should create todo_item" do
    assert_difference('TodoItem.count') do
      post :create, todo_item: { description: @todo_item.description, done: @todo_item.done, due_date: @todo_item.due_date, task_title: @todo_item.task_title }
    end
  ...
  test "should update todo_item" do
    put :update, id: @todo_item, todo_item: { description: @todo_item.description, done: @todo_item.done, due_date: @todo_item.due_date, task_title: @todo_item.task_title }
    assert_redirected_to todo_item_path(assigns(:todo_item))
  end
