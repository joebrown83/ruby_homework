...
TodoItem.create [
  {due_date: '2012-12-31', task_title: "New York", description: "Visit New York City"},
  {due_date: '2013-04-30', task_title: "Paris", description: "Visit Paris in the spring"},
  {due_date: '2013-04-30', task_title: "Chicago", description: "Convention in Chicago"},
  {due_date: '2012-11-5', task_title: "Kitchen", description: "Clean kitchen counters"},
  {due_date: '2012-11-9', task_title: "Living room", description: "Dust living room"},
  {due_date: '2012-11-10', task_title: "Dog", description: "Give dog a bath"},
  {due_date: '2012-11-22', task_title: "Soup", description: "Make potato soup"},
  {due_date: '2012-11-22', task_title: "Turkey", description: "Roast turkey"},
  {due_date: '2012-11-22', task_title: "Pie", description: "Bake pumpkin pie"}
]
...
User.find_by_login("jbrown").todo_lists << TodoList.find_by_list_name("traveling")
User.find_by_login("jbrown").todo_lists << TodoList.find_by_list_name("cleaning")
User.find_by_login("janesmith").todo_lists << TodoList.find_by_list_name("cooking")
